local module = ShaguTweaks:register({
    title = "Mouseover Main ActionBar",
    description = "Hide the main ActionBar and show on mouseover. The pet/shapeshift/aura/stance bars will not be clickable if in the same position as the mouseover bar.",
...
module.enable = function(self)
    ...
    local function castbar()
        ...
        if not ShaguTweaks.MainMenuBar then
        ...
        elseif ShaguTweaks.MainMenuBar then
            CastingBarFrame:SetPoint("BOTTOM", MainMenuBar, "TOP", 0, h*1.5)
            lock(CastingBarFrame)
        end
